...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/polished-hall-a429
```

A live public deployment of this template is available at [https://polished-hall-a429.templates.workers.dev](https://polished-hall-a429.templates.workers.dev)
